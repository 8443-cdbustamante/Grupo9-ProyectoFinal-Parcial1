...
Data = pd.read_csv('dataset_administrador.csv', sep=",", header=0,index_col=0)
...
try:
    ...
    if conn:
        ...
        for i,row in Data.iterrows():
            sql = 'INSERT INTO tb_administrador("var_id_per" ,"nbr_num_proyectos_realizados") VALUES(:1,:2)'
