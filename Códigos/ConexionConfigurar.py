...
Data = pd.read_csv('dataset_configurar.csv', sep=",", header=0,index_col=0)
...
try:
    ...
    if conn:
        ...
        for i,row in Data.iterrows():
            sql = 'INSERT INTO tb_configurar("var_descripcion_conf","var_id_perm" ,"var_id_rol") VALUES(:1,:2,:3)'
